"""Dataset loading utilities for twenty-seven-day forecasts."""
...
def load_dataset() -> pd.DataFrame:
    """Load and clean the locally stored twenty-seven-day forecast dataset.
    ...
    logger.info("Loading twenty-seven-day forecast dataset from %s", csv_path)
